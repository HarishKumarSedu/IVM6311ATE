...
if __name__ == '__main__':
    ...
    trim.mcp.mcpWrite(SlaveAddress=trim.slave_address, data=[0xB2, 0xD4])
    ...
    trim.mcp.mcpWrite(SlaveAddress=trim.slave_address, data=[0xB2, 0xD6])
    trim.mcp.mcpWrite(SlaveAddress=trim.slave_address, data=[0xC0, 0x01])
    trim.mcp.mcpWrite(SlaveAddress=trim.slave_address, data=[0xFE, 0x01])
